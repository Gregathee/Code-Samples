...
SFMLCircleRenderShape::SFMLCircleRenderShape ()
{
	shape.setRadius ( 0 ); 
	shape.setOrigin ( shape.getRadius (), shape.getRadius() );
}

SFMLCircleRenderShape::SFMLCircleRenderShape ( float newRadius )
{
	SetRadius ( newRadius ); 
	shape.setOrigin ( shape.getRadius (), shape.getRadius () );
}
...
void SFMLCircleRenderShape::SetRotation ( float newRotation ) { shape.setRotation ( newRotation ); }

float SFMLCircleRenderShape::GetRotation () { return shape.getRotation(); }
