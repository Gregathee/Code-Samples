    ...
    public class TP_Wep_TargetingSystem : TP_Weapon
    {
        ...
        public override void SaveToFile()
        {
            ...
            Dictionary<string, string> dict = new Dictionary<string, string>()
            {
                ...
                {"Basic Priority", HU_Functions.BoolToInt(_movementTypePriorityTargeting).ToString()},
                {"Advanced Priority", HU_Functions.BoolToInt(_advancedPositionPriorityTarget).ToString()},
                {"Detect Stealth", HU_Functions.BoolToInt(_canDetectStealth).ToString()}
            };
        ...
        public override void SetPropertiesFromJSON(Dictionary<string, string> jsonDict)
        {
            ...
            _movementTypePriorityTargeting = HU_Functions.IntToBool(int.Parse(jsonDict["Basic Priority"]));
            _advancedPositionPriorityTarget = HU_Functions.IntToBool(int.Parse(jsonDict["Advanced Priority"]));
            _canDetectStealth = HU_Functions.IntToBool(int.Parse(jsonDict["Detect Stealth"]));
